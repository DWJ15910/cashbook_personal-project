					...
					<div class="col-12">
						<div class="card">
							...
							<table class="table">
								...
								<tr>
									<td colspan="2"><a class="btn btn btn-secondary" style="float: right;" href="${pageContext.request.contextPath}/on/modifyMember">수정하기</a></td>
								</tr>
								<tr>
									<td colspan="2"><a class="btn btn btn-danger" style="float: right;" href="${pageContext.request.contextPath}/on/removeMember">회원탈퇴</a></td>
								</tr>
							</table>
						</div>
					</div>
